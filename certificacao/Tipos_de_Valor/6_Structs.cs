...
namespace certificacao
{
    partial class Program
    {
        static void ExecutarStructs()
        {
            ...
            Console.WriteLine("Latitude1 = {0}", Latitude1);
            Console.WriteLine("Longitude1 = {0}", Longitude1);
            Console.WriteLine("Latitude2 = {0}", Latitude2);
            Console.WriteLine("Longitude2 = {0}", Longitude2);
